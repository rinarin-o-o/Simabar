...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Jadwal Penggunaan Fasilitas Umum</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
        <li class="breadcrumb-item">Jadwal Penggunaan</li>
        <li class="breadcrumb-item active">Fasum</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr class="text-center">
        <th scope="row">1</th>
        <td>Parkir</td>
        <td>Tempat Parkir Umum Kegiatan Visitasi</td>
        <td>Senin, 28 Oktober 2024 
            <br>08:00-11.30</td>
        <td>Bidang Humas</td>
